/**
 * Restore trusted enrichment for 801 Jul 16–20 placeholder from CONFIRMED email audit.
 * node scripts/restore-margarita-enrichment.mjs [--dry-run]
 */
...
const AUDIT_ID = "cmqudmxju000004l2gplsqrnb";
const RESERVATION_ID = "cmqzv96n4000604l8dbkm7u4y";
const CODE = "HMH448K3N2";
const GUEST = "Margarita Guillen Villafuerte";
...
const update = {
  ...
  internalNotes: `Enriquecido certificación · audit ${AUDIT_ID}`,
