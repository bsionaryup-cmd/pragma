...
import { getSubscriptionStatusAction } from "@/features/billing/actions/billing.actions";
...
export function BillingCheckoutFeedback({ paid = false }: BillingCheckoutFeedbackProps) {
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => {
      attempts += 1;
      void getSubscriptionStatusAction().then((s) => {
