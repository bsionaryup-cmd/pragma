export const es = {
  ...
  smartprice: {
    ...
    pricing: {
      ...
      base: "Base",
      max: "Máximo",
      recommended: "Tarifa hoy",
      recommendedHint: "Calendario PriceLabs",
      difference: "Diferencia",
      differenceHint: "vs tarifa sin personalizar",
      revenue: "Ingresos",
      empty: "Agrega propiedades activas para configurar tarifas.",
      anomaliesOnly: "Solo anomalías",
      anomaliesEmpty:
        "Sin anomalías pendientes. Desactiva el filtro para ver todas las propiedades.",
      calendarTitle: "Precios y estancia mínima · 7 días",
      calendarFullLink: "Ver calendario completo",
      calendarEmpty:
        "Sin precios diarios sincronizados. Ve a Integraciones → Importar precios.",
      calendarDayHint: "Toca un día para crear un ajuste puntual",
      adjustmentsTitle: "Ajustes por fecha",
      refreshListing: "Actualizar datos",
      saveAdjustment: "Guardar ajuste",
      adjustmentsEmpty: "Sin ajustes puntuales próximos.",
      badgeAdjustments: "{{count}} ajustes",
      badgeMinStay: "Mín. {{count}} noches",
      badgeMinStayToday: "Hoy: {{count}} noches",
      fields: {
        date: "Fecha",
        price: "Precio",
        minNights: "Noches mín.",
        minPrice: "Precio mín.",
        maxPrice: "Precio máx.",
      },
    },
    insights: {
      health: "Estado de tarifas",
      alerts: "Alertas de tarifa",
      syncIssues: "Errores de sincronización",
    },
    sync: {
